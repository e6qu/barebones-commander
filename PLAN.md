...
| **15** | in flight | **Dead-code sweep** — GrowlNotifier, TerminalPanel, MailPanel + SendMailJob, BrowsableItemsMenuService(Tracker), dead protocol-handler registrations (FTP/HTTP/HDFS/WEBDAV/VSPHERE), Bonjour pref bits, two large commented-out code blocks, ~900 stale i18n keys across 28 dictionaries. Net **−2,075 LOC**. | one PR |
